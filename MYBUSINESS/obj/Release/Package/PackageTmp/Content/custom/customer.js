...
function OnTypeCustomerName(param) {
    ...
    $(param).keyup(function (e) {
        ...
        if (displayCntr > 0) {
            ...
            $("#dialog-customers").dialog("open");
            document.getElementById('customer').focus();
        } else {
            $("#dialog-customers").dialog("close");

        }

        ConfigDialogueCustomer('#customer');
...
$(function () {
    ...
    $('#dialog-customers').find('tr').click(function () {
    ...
    $('#dialog-products').find('tr').click(function () {
        ...
        $('#salePrice' + clickedIdNum).val(col2);
...
$(document).ready(function () {
    ...
    $("#addNewRow").click(function () {
        ...
        var row = '<tr>' +
            ...
            '<td><input type="text" readonly class="form-control classBGcolor" name="salePrice' + txtSerialNum + '" id="salePrice' + txtSerialNum + '"></td>' +
            '<td><input type="text" class="form-control" name="SaleOrderDetail[' + txtSerialNum + '].Quantity" id="quantity' + txtSerialNum + '"></td>' +
    ...
    $('[id^="quantity"],#salePrice,#discount,#paid').keyup(function () {
...
function ConfigDialogueCustomer(param) {
    //alert(param);
    $("#dialog-customers").dialog({
