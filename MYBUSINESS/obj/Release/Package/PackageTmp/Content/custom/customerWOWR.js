var productColumns = [{ name: 'Id', minWidth: '100px' }, { name: 'Product', minWidth: '320px' }, { name: 'Sale Price', minWidth: '100px' }, { name: 'Qty', minWidth: '70px' }];
...
$(document).ready(function () {
    ...
    $("#addNewRow").click(function (e) {
        ...
        var row = '<tr>' +
            ...
            '<td><input type="text"  class="form-control autocomplete="off" classBGcolor" name="SaleOrderDetail[' + txtSerialNum + '].ShortFall" id="shortFall' + txtSerialNum + '"></td>' +
            ...
            '<td><input type="text" class="form-control classBGcolor" name="remarks' + txtSerialNum + '" id="remarks' + txtSerialNum + '"tabindex="-1"></td>' +            
