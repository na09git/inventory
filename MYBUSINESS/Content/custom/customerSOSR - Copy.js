var productColumns = [{ name: 'Id', minWidth: '100px' }, { name: 'Product', minWidth: '320px' }, { name: 'Sale Price', minWidth: '100px' }, { name: 'Packing', minWidth: '70px' }, { name: 'PerPack', minWidth: '70px' }];
